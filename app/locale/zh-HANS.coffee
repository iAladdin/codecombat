...
#    recruitment_reminder: "Use this form to reach out to candidates you are interested in interviewing. Remember that CodeCombat charges 15% of first-year salary. The fee is due upon hiring the employee and is refundable for 90 days if the employee does not remain employed. Part time, remote, and contract employees are free, as are interns." # Deprecated
  ...
  community:
    ...
    article_editor_prefix: "在文档中发现错误了吗？想为你自己的创造杰作写一些说明？来使用"
  ...
  editor:
    ...
    level_component_tab_title: "本关组件"
    level_component_btn_new: "创建新的组件"
    level_systems_tab_title: "本关系统"
    ...
    level_component_config_schema: "配置Schema"
    ...
    new_article_title: "创建一个新文档"
    new_thang_title: "创建一个新物品类型"
    new_level_title: "创建一个新关卡"
    new_article_title_login: "登录以创建新文档"
